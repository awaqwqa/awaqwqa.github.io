...
- `manifest`标签
  ...
  ![mainifest](https://VitaElegy.github.io/img/xml文件格式分析/mainifest.png)
...
- `application` 标签
  ...
  ![application](https://VitaElegy.github.io/img/xml文件格式分析/application.png)

## 默认activity

> 往往一些实际项目中我们xml文件中有多个`activity`标签

![more_activity](https://VitaElegy.github.io/img/xml文件格式分析/more_activity.png)
...
- `action` 属性定义了我们的一些系统行为
  ...
  - ` ACTION_MAIN`
    ...
    ![action_main](https://VitaElegy.github.io/img/xml文件格式分析/action_main.png)

  - `ACTION_VIEW`

    > 会根据不同的参数来打开不同的界面 详细看[Intent的各种Action - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/579244790)

    ![intent_filter_view](https://VitaElegy.github.io/img/xml文件格式分析/intent_filter_view.png)
...
![main_activity_filter](https://VitaElegy.github.io/img/xml文件格式分析/main_activity_filter.png)
