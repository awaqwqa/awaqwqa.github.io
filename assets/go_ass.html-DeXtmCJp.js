import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as i,e}from"./app-4DI25i_s.js";const a={},l=e(`<h1 id="cgo" tabindex="-1"><a class="header-anchor" href="#cgo" aria-hidden="true">#</a> CGO</h1><h2 id="汇编" tabindex="-1"><a class="header-anchor" href="#汇编" aria-hidden="true">#</a> 汇编</h2><blockquote><p>参考文章:https://mp.weixin.qq.com/s/YtTY23cWaE3M5ygAurj1Ig</p><p>GO语言的汇编并不是针对硬件框架的汇编,而是抽象出来的可移植汇编</p><p>使用的是<strong>GAS</strong>汇编,也就是(Gnu ASsembler) 可以通过</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>go build <span class="token parameter variable">-gcflags</span> <span class="token string">&quot;-N -l -S&quot;</span> main.go <span class="token number">2</span> <span class="token operator">&gt;</span> main.s
