import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as r,c,a as n,b as e,d as a,e as s}from"./app-LjADdXUT.js";const o={},t=s('<h1 id="ret2dl" tabindex="-1"><a class="header-anchor" href="#ret2dl" aria-hidden="true">#</a> ret2dl</h1><h2 id="部分前置知识讲解" tabindex="-1"><a class="header-anchor" href="#部分前置知识讲解" aria-hidden="true">#</a> 部分前置知识讲解</h2><h3 id="got表和plt表详细解说" tabindex="-1"><a class="header-anchor" href="#got表和plt表详细解说" aria-hidden="true">#</a> got表和plt表详细解说</h3>',3),u={href:"https://zhuanlan.zhihu.com/p/134105591",target:"_blank",rel:"noopener noreferrer"},p=n("br",null,null,-1),v=s(`<ul><li><p>运行PLT[1]</p><blockquote><p>由于我是是第一次的调用 所以GOT[3]的内容为:<code>PLT[1]</code>中<code>push reloc_arg;</code>指令的地址 也就是会自动跳转PLT[0]去完成绑定 并且 将reloc_arg参数作为参数<br>这里PLT[N]与GOT[2+N]一 一对应</p></blockquote><div class="language-assembly line-numbers-mode" data-ext="assembly"><pre class="language-assembly"><code>jmp [GOT[3]]; 
push reloc_arg;
jmp PLT[0];
